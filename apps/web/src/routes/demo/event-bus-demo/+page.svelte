<!-- demo-meta:
{
  ...
  "description": "Interactive demo for event-bus-demo",
  "tags": ["demo"],
  "status": "wip"
}
-->
...
<script lang="ts">
  ...
  onMount(async () => {
    try {
      ...
      initialized = true;
      console.log('[Demo] Event Bus Demo initialized');
    } catch (e) {
...
<div class="demo-container">
  ...
  <section class="demo-section">
    ...
    <p>🔍 Feature available at <code>window.__eventBusDemo</code> (DEV mode)</p>
