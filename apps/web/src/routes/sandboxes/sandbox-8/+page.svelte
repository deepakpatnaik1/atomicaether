...
<div class="test-controls">
  ...
  <div class="test-section">
    ...
    <div class="btt-instructions">
      ...
      <p><strong>• Browser Independence:</strong> Input bar looks different in Chrome vs Firefox. Need consistent cross-browser styling and layout</p>
      <p><strong>• Hotkey Conflict:</strong> CTRL+OPTION+D conflicts with Magnet's right-1/3 screen mode. Need alternative hotkey for scrolling screenshot</p>
    </div>
  </div>
  ...
  <div class="test-section">
    ...
    <div class="btt-instructions">
      ...
      <p><strong>File Capture (CTRL+OPTION+F):</strong></p>
      <p>1. User selects file in Finder<br/>
      2. User presses CTRL+OPTION+F<br/>
      3. Selected file appears as file preview in input bar</p>
      
      <p><strong>URL Capture (CTRL+OPTION+U):</strong></p>
      <p>1. User is browsing any website<br/>
      2. User presses CTRL+OPTION+U<br/>
      3. Current webpage URL appears as link preview in input bar</p>
      
      <p><strong>Scrolling Screenshot (CTRL+OPTION+D):</strong></p>
      <p>1. User presses CTRL+OPTION+D<br/>
      2. BetterTouchTool triggers Shottr scrolling capture<br/>
      3. Long screenshot appears as image preview in input bar<br/>
      <em>(Captures entire webpages, documents, chat conversations)</em></p>
    </div>
  </div>
</div>
