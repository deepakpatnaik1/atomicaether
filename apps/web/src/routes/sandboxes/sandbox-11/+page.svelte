<script lang="ts">
  ...
  const models = {
    'Anthropic': [
      { name: 'Claude 4 Sonnet', id: 'claude-sonnet-4-20250514' },
      { name: 'Claude 4 Opus', id: 'claude-opus-4-20250514' }
    ],
    'OpenAI': [
      { name: 'GPT 4.1 Mini', id: 'gpt-4.1-mini-2025-04-14' }
    ],
    'Firefox': [
      { name: 'Llama 4 Maverick', id: 'meta.llama-4-maverick-17b-128e-instruct-fp8' }
    ]
  };
  ...
  const themes = {
    'Dark': [
      { name: 'Rainy Night', id: 'rainy-night' },
      { name: 'Midnight Blue', id: 'midnight-blue' },
      { name: 'Deep Purple', id: 'deep-purple' }
    ],
    'Light': [
      { name: 'Arctic White', id: 'arctic-white' },
  ...
  function getSelectedModelName() {
    for (const [company, modelList] of Object.entries(models)) {
  ...
  function getSelectedPersonaName() {
    for (const [category, personaList] of Object.entries(personas)) {
  ...
  function getSelectedThemeName() {
    for (const [category, themeList] of Object.entries(themes)) {
    ...
    <div class="controls-row">
      ...
      <div class="dropdown-container">
        ...
        {#if showModelDropdown}
          <div class="dropdown-menu">
            {#each Object.entries(models) as [company, modelList]}
      ...
      <div class="dropdown-container">
        ...
        {#if showPersonaDropdown}
          <div class="dropdown-menu">
            {#each Object.entries(personas) as [category, personaList]}
              <div class="dropdown-section">
      ...
      <div class="dropdown-container">
        ...
        {#if showThemeDropdown}
          <div class="dropdown-menu">
            {#each Object.entries(themes) as [category, themeList]}
              <div class="dropdown-section">
                <div class="section-header">{category}</div>
                <div class="section-content">
                  {#each themeList as theme}
                    ...
                    >
                      <span class="model-name">{theme.name}</span>
                      <span class="model-id">{theme.id}</span>
                    </button>
                  {/each}
                </div>
              </div>
